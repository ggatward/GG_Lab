...
ipa dnsrecord-add ocp.home.gatwards.org proxy --a-ip-address=172.22.5.99 --a-create-reverse
...
ipa dnsrecord-add ocp.home.gatwards.org api.lab --a-ip-address=172.22.5.99
ipa dnsrecord-add ocp.home.gatwards.org api-int.lab --a-ip-address=172.22.5.99
ipa dnsrecord-add ocp.home.gatwards.org *.apps.lab --a-ip-address=172.22.5.99
